...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(python
     ...
     ;; ----------------------------------------------------------------
     ;; Add LSP configuration to the python layer
     (python :variables
             python-backend 'lsp       ; Use LSP as the backend
             python-lsp-server 'pylsp  ; Specify pylsp as the LSP server
             python-formatter 'black   ; Optional: if you use black for formatting
             python-sort-imports t    ; Optional: enable import sorting
             ;; Enable virtual environment detection
             python-enable-virtualenv t
             ;; Set the directory where your virtualenvs are stored
             python-virtualenvs-directory "~/env/"
             )
     auto-completion
     better-defaults
     emacs-lisp
